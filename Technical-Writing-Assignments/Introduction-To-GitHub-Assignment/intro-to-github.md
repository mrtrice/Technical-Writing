...
## Introduction
 ...
 ## What is GitHub
 GitHub is simply a cloud web-based Git repository hosting service. This simply means that GitHub helps programmers or computer technicians to easily use the inbuilt installed Git repository on the cloud and work as a team or access it remotely instead of locally within their system alone.
...
GitHub Desktop is a software or an application built by the GitHub team to enable us to interact with our GitHub account using a Graphic User Interface, instead of using the command line or the web browser. 
...
* GitHub Desktop uses Graphic User Interface to interact.

* GitHub CLI makes use of Terminal and command lines to perform actions.
...
Clone is the process of copying a Repository or Project from a cloud-hosted like GitHub or anywhere on the internet to your own personal local computer or machine. 
...
2. Click **URL** Tab
    ...
    i. For **URL**, Paste the Repository link from the GitHub website.

    ii. For **Local Path**, Select the location you want to save the repository on your **local computer**.
...
## How to Clone on CLI
To clone with CLI, we need CLI software, such as Git Bash, Command Prompt, and Windows Power shell (Terminal). First, we have to understand what is CLI. CLI simply means Command-Line. In this case, we use code commands to act. I will be using Git Bash for this process. To clone on CLI, follow these steps: 
...
4. Type **git clone** **<REMOTE_URL>**
    ...
    a. For **<REMOTE_URL>**, Paste the Repository link from the GitHub website.
...
To Commit on GitHub desktop, you are required to have an account with GitHub, Download the GitHub Desktop, and login using your GitHub log in details in other to see the Repository you cloned earlier or any of the Repositories you already have. If you don't have GitHub Desktop yet, you can download one **[here](https://desktop.github.com/)**, also create an account **[here](https://github.com/signup)** if you don't have one yet. Before I commit, I need to make changes to the Repository first. To make changes, follow these steps:
...
3. Choose a **Repository** or use the **Add Button** to Add one.
   ...
   ![GitHub Desktop HomePage](images/github-d-arrow2.jpg)
    ...
    a. In my own case, I will choose an existing Repository **“Vuetify-responsive”**.
...
## Pull request
Here comes another important section of this article. In this section, I will guide you on how to Pull request on GitHub Desktop and CLI. But first,  we need to know what is Pull request.
...
In this section, I will assume you have committed the repository already as discussed above. If you dont know what is Commit, I will recommend you check the previous section of this article for that.  To pull request on GitHub Desktop, follow these steps:
...
## Conclusion
With all being said above, I believe it will be much easier to understand a little about GitHub and how it functions. 
